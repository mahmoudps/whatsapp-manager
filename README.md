...
استخدام `wa-manager env` لعرض الملف والتحقق من أن المتغير
`NEXT_PUBLIC_WEBSOCKET_URL` يشير إلى نطاقك. إذا أجريت أي تعديل على
الملف يفضل إعادة تشغيل الحاويات عبر `wa-manager restart` لتطبيقه.
